...
class ActionAutoMapper @Inject constructor() {
    ...
    private val actionAliases: Map<String, String> = mapOf(
        ...
        // ── Instagram Reels variants ─────────────────────────────────
        "OPEN_REELS"              to "OPEN_INSTAGRAM_REELS",
        "SHOW_REELS"              to "OPEN_INSTAGRAM_REELS",
        "PLAY_REELS"              to "OPEN_INSTAGRAM_REELS",
        "REELS"                   to "OPEN_INSTAGRAM_REELS",
        "GO_TO_REELS"             to "OPEN_INSTAGRAM_REELS",
        "INSTAGRAM_REELS"         to "OPEN_INSTAGRAM_REELS",
        "NEXT_REEL"               to "SWIPE_DIRECTION",
        "SKIP_REEL"               to "SWIPE_DIRECTION",

        // ── Instagram Direct/DM variants ─────────────────────────────
        "OPEN_INSTAGRAM_MESSAGES"     to "OPEN_INSTAGRAM_DIRECT",
        "OPEN_INSTAGRAM_DMS"          to "OPEN_INSTAGRAM_DIRECT",
        "OPEN_INSTAGRAM_DM"           to "OPEN_INSTAGRAM_DIRECT",
        "INSTAGRAM_DIRECT_MESSAGE"    to "OPEN_INSTAGRAM_DIRECT",
        "INSTAGRAM_MESSAGES"          to "OPEN_INSTAGRAM_DIRECT",
        "INSTAGRAM_INBOX"             to "OPEN_INSTAGRAM_DIRECT",
        "CHECK_INSTAGRAM_MESSAGES"    to "OPEN_INSTAGRAM_DIRECT",

        // ── Instagram profile variants ────────────────────────────────
        "VIEW_INSTAGRAM_PROFILE"      to "OPEN_INSTAGRAM_PROFILE",
        "SHOW_INSTAGRAM_PROFILE"      to "OPEN_INSTAGRAM_PROFILE",
        "OPEN_INSTAGRAM_ACCOUNT"      to "OPEN_INSTAGRAM_PROFILE",

        // ── YouTube Shorts variants (same feed-swipe pattern as Reels) ─
        "OPEN_YOUTUBE_SHORTS"     to "OPEN_YOUTUBE_SHORTS",
        "SHOW_SHORTS"             to "OPEN_YOUTUBE_SHORTS",
        "PLAY_SHORTS"             to "OPEN_YOUTUBE_SHORTS",
        "SHORTS"                  to "OPEN_YOUTUBE_SHORTS",
        "GO_TO_SHORTS"            to "OPEN_YOUTUBE_SHORTS",
        "NEXT_SHORT"              to "SWIPE_DIRECTION",
        "SKIP_SHORT"              to "SWIPE_DIRECTION",

        // ── TikTok variants (feed swiping) ───────────────────────────
        "NEXT_TIKTOK"             to "SWIPE_DIRECTION",
        "SKIP_TIKTOK"             to "SWIPE_DIRECTION",
        "NEXT_VIDEO"              to "SWIPE_DIRECTION",

        // ── Swipe/gesture variants ────────────────────────────────────
        "SWIPE_UP"                to "SWIPE_DIRECTION",
        "SWIPE_DOWN"              to "SWIPE_DIRECTION",
        "SWIPE_LEFT"              to "SWIPE_DIRECTION",
        "SWIPE_RIGHT"             to "SWIPE_DIRECTION",
        "PERFORM_SWIPE"           to "SWIPE_DIRECTION",
        "SWIPE_SCREEN"            to "SWIPE_DIRECTION",
        "FLING"                   to "SWIPE_DIRECTION",
        "LONG_PRESS"              to "LONG_PRESS_COORDINATES",
        "HOLD_PRESS"              to "LONG_PRESS_COORDINATES",
        "LONG_CLICK"              to "LONG_PRESS_COORDINATES",

        // ── Guide/help-in-app variants ────────────────────────────────
        "HELP_ME"                 to "GUIDE_ME",
        "HELP_HERE"               to "GUIDE_ME",
        "WALK_ME_THROUGH"         to "GUIDE_ME",
        "GUIDE"                   to "GUIDE_ME",
        "ASSIST_IN_APP"           to "GUIDE_ME",
        "EXPLAIN_SCREEN"          to "GUIDE_ME",
        "WHAT_DO_I_DO"            to "GUIDE_ME"
    )
