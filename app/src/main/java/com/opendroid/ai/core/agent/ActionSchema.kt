...
object ActionSchema {
    ...
    val ALL_ACTIONS = listOf(
        ...
        ActionDefinition(
            name = "GUIDE_ME",
            description = """Looks at the current screen and gives step-by-step guidance for what to
                do next inside whatever app the user currently has open. Use this whenever the user
                seems stuck inside an app, or explicitly asks for help/guidance mid-task, rather than
                ANALYZE_SCREENSHOT (which just describes the screen).""",
            params = listOf(
                ParamDefinition("goal", ParamType.STRING, false, "What the user is trying to accomplish in this app, if known", defaultValue = "")
            ),
            examples = listOf(
                "guide me", "help me here", "what do I do now", "walk me through this",
                "I'm stuck, help", "how do I do this in this app"
            ),
            category = ActionCategory.SYSTEM
        ),
        ...
        ActionDefinition(
            name = "OPEN_INSTAGRAM_REELS",
            description = "Opens Instagram directly to the Reels feed (not just the app home screen)",
            params = emptyList(),
            examples = listOf(
                "open instagram reels", "go to instagram reels", "show me reels", "open reels"
            ),
            category = ActionCategory.COMMUNICATION
        ),
        ActionDefinition(
            name = "OPEN_INSTAGRAM_DIRECT",
            description = "Opens Instagram directly to the Direct Messages inbox",
            params = emptyList(),
            examples = listOf(
                "open instagram messages", "open instagram dms", "check my instagram messages",
        ...
        ActionDefinition(
            ...
            description = "Opens a specific Instagram profile (or the user's own profile if no username is given)",
            params = listOf(
                ParamDefinition("username", ParamType.STRING, false, "Instagram username to open, without the @", defaultValue = "")
            ),
            examples = listOf("open instagram profile of natgeo", "show my instagram profile"),
            category = ActionCategory.COMMUNICATION
        ),
        ...
        ActionDefinition(
            name = "OPEN_YOUTUBE_SHORTS",
            description = "Opens YouTube directly into the Shorts feed (optionally searching for a topic first)",
            params = listOf(ParamDefinition("query", ParamType.STRING, false, "Optional topic to search Shorts for", defaultValue = "")),
            examples = listOf(
                "open youtube shorts", "show me shorts", "play some shorts",
        ...
        ActionDefinition(
            ...
            description = "Long-presses (holds) at specific screen coordinates, e.g. to open a context menu or reaction bar",
            params = listOf(
                ParamDefinition("x", ParamType.STRING, true, "X coordinate"),
                ParamDefinition("y", ParamType.STRING, true, "Y coordinate")
            ),
            examples = listOf("long press on the message", "hold this button"),
            category = ActionCategory.ADVANCED
        ),
        ActionDefinition(
            name = "SWIPE_DIRECTION",
            description = """Swipes across most of the screen in a direction (up/down/left/right).
                Use this for feed-style apps where SCROLL doesn't work — e.g. Instagram
                Reels, TikTok, YouTube Shorts, or any full-screen swipeable card feed.""",
            params = listOf(
                ParamDefinition(
                    name = "direction",
                    type = ParamType.ENUM,
            ...
            examples = listOf(
                "swipe up", "next reel", "skip this reel", "swipe left", "next video",
                "go to the next short"
            ),
            category = ActionCategory.ADVANCED
        ),
        ActionDefinition(
            name = "SWIPE",
            description = "Swipes from one exact screen coordinate to another. Use SWIPE_DIRECTION instead unless precise coordinates are required.",
            params = listOf(
                ParamDefinition("x1", ParamType.STRING, true, "Start X coordinate"),
                ParamDefinition("y1", ParamType.STRING, true, "Start Y coordinate"),
                ParamDefinition("x2", ParamType.STRING, true, "End X coordinate"),
                ParamDefinition("y2", ParamType.STRING, true, "End Y coordinate"),
                ParamDefinition("durationMs", ParamType.STRING, false, "Swipe duration in milliseconds", defaultValue = "300")
            ),
            examples = listOf("swipe from here to there"),
            category = ActionCategory.ADVANCED
        ),
